...
exp_name="32B_r64_alpha128_1e-6_from_raft_r128"
...
#######################################################################
n_resp_per_prompt=8
jepo_lr=1e-4 # Qwen -> 1e-6, 5e-7, Mistral -> 5e-8, lora = full-finetuning * 10 
...
MODEL_PATH="/blob/v-tianyuchen/Projects/jepo/ckpts/JEPO_token_Dec13/Qwen3-32B-RAFT_epoch5/global_step_390/merged_model"
...
ray job submit \
    ...
    actor_rollout_ref.model.lora_alpha=256.0
