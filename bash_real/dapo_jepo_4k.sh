...
real_ppo_max_token_len=$(((max_prompt_length + max_response_length) * 4))
real_mini_batch_size_per_gpu=8 # responses per gpu
real_micro_batch_size_per_gpu=2 # responses per gpu
...
python3 -m recipe.dapo.main_real_dapo \
    ...
    +algorithm.real_ppo_max_token_len_per_gpu=${real_ppo_max_token_len} \
    ...
    +algorithm.real_show_all_rank_pbar_to_file=True
